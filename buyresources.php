...
<br /><br /><br />
<h2>Buy 100k of Each Resource <img src="img/x.gif" class="r1">100k <img src="img/x.gif" class="r1">100k <img src="img/x.gif" class="r3">100k <img src="img/x.gif" class="r4">100k</h2><br />
...
$uid = '$session->uid';
$vref = '$village->wid';
mysql_query("UPDATE ".TB_PREFIX."users SET `gold` = `gold`- 100  WHERE id =".$session->uid."")or die(mysql_error());            
mysql_query("UPDATE ".TB_PREFIX."vdata SET `wood` = `wood` + 100000.00 WHERE wref =".$village->wid."")or die(mysql_error());
mysql_query("UPDATE ".TB_PREFIX."vdata SET `clay` = `clay` + 100000.00 WHERE wref =".$village->wid."")or die(mysql_error());
mysql_query("UPDATE ".TB_PREFIX."vdata SET `iron` = `iron` + 100000.00 WHERE wref =".$village->wid."")or die(mysql_error());
mysql_query("UPDATE ".TB_PREFIX."vdata SET `crop` = `crop` + 100000.00 WHERE wref =".$village->wid."")or die(mysql_error());
echo "<h2>100k Wood, Clay, Iron, Crop, Added at the cost of 100 Gold.</h2>";}}?>
</div>
<div id="side_info">
<?php
