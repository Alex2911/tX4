...
<div class="server serverA serverbig servernew serverbignew ">
	<a class="link" title="Register on Server 2" href="anmelden.php" onclick="">
...
<div class="server serverA serverbig serverpreRegister serverbigpreRegister ">
    <a class="link" title="Register on Server 3" href="anmelden.php" onclick="">
    <span class="name">Server 3</span>
    <span class="start">
