...
<br /><br /><br />
<h2>Puy 250 Population for this Village</hr><br />
...
<input type="submit" name="submit" value="Add 250 Pop to This Village"> 
</td></tr> 
</table> 
</form> 
<?php
...
mysql_query("UPDATE ".TB_PREFIX."users SET `gold` = `gold`- 25 WHERE id ='".$session->uid."'")or die(mysql_error());    
mysql_query("UPDATE ".TB_PREFIX."vdata SET `pop` = `pop`+250  WHERE wref ='".$village->wid."'")or die(mysql_error());
echo "<h2>250 Pop at the Cost of 25 Gold.</h2>";}}?>
<br>
</div>
<div id="side_info">
<?php
