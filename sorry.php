	...
	<div id="wrapper">
			...
			<div id="contentOuterContainer">
				...
				<div class="contentContainer">
					<div id="content" class="login">
						...
						<h4>Sorry, but the server will be closed for a some time to fix some bugs and rework it to RavianX Graphcis.
                        <br /><br />Please come back soon.
                        <br /><br />We are working for a better tomorrow.</h4>
						<noscript>
                        	<div id="noJavaScript">
                            	JavaScript is deactivated. You must activate it in your browser settings to be able to play RavianX.
                            </div>
						</noscript>
                        <!--
        ...
        <div id="side_info">
			<div class="news news1">
            	The new server is coming soon, it will run on version RavianX.
                <br />
                <br />
			...
			<div class="news news2">
				...
				<a class="newsContentMoreInfoLink" target="_blank" href="http://forum.ravianx.com">
                	...more information
                </a> -->
			</div>
		</div>
		...
		<div id="footer">
			...
			<p class="copyright">
            © 2011 Zravian | By <a href="http://ravianx.com">RavianX</a>
            </p>
		</div>
		<div id="anwersQuestionMark">
        	<a href="/help" target="_blank" title="RavianX Answers">&nbsp;</a>
		</div>
	</div>
	<div id="ce"></div>
</div>
