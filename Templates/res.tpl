...
<div id="resWrap">
	...
	<table cellpadding="1" cellspacing="1">
        ...
        <td></td>
			<td><?php 
			if($silver <= 1){
            echo '<font color="#B3B3B3"><img src="'.GP_LOCATE.'img/a/silver.gif" alt="Remaining gold" title="You currently have: '.$silver.' silver"/> '.$silver.' <span><span>S</span><span>i</span><span>l</span><span>ver</span></span></font>';
			}
			else if($silver >=2){
			echo '<img src="'.GP_LOCATE.'img/a/silver.gif" alt="Remaining gold" title="You currently have: '.$silver.' gold"/> '.$silver.' <span><span>S</span><span>i</span><span>l</span><span>ver</span></span>';
			}
			?>
			</td>
