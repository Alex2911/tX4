...
<body>
    ...
    <div id="side_navi">
        ...
        <p><a href="<?php echo HOMEPAGE; ?>"><?php echo HOME; ?></a> <a href="spieler.php?uid=<?php echo $session->uid; ?>"><?php echo PROFILE; ?></a> <a href="#" onclick="return Popup(0,0,1);"><?php echo INSTRUCT; ?></a> <?php if($session->access == MULTIHUNTER) {
                    ...
                    } ?> <a href="herofix.php">Hero fix </a> <a href="herom.php"><font color="Red">Hero Market </font></b><br /></a> <a href="hunt.php"><font color="blue">Go Hunting </font></b><br /></a> <a href="logout.php"><?php echo LOGOUT; ?></a></p>
