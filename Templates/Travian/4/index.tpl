...
<body class=" LTR">
		...
		<div id="navigation-wrapper">
	    	<div id="navigation-container">
	        	<div id="country_select">
					<div id="flags"></div>
                    <script src="flags.js1" type="text/javascript"></script>
				</div>
	            <div id="top-nav">
                    <div id="top-nav-menu">
                        <div id="logo">
				...
				<div id="statistics">
                    ...
                    <div id="stat_bottom"></div>
                    	...
                    	<div>
                            ...
                            <div class="stat value"><?php echo $online; ?></div>
							<div class="clear"></div>
	                	</div>
                	</div>
	...
	<div id="footer-container">
		<div id="footer">
			<br />
			&copy; 2012 - <a target="blank" class="flink" href="#">RavianX</a> - All rights reserved
		</div>
	</div>
