...
##  Project:       ZravianX                                                    ##
##  Version:       2011.11.25                                                  ##
##  Filename:      Templates/Travian/4/Build/ww.tpl                            ##
##  Developed by:  Dixie                                                       ##
##  Reworked by:   Dzoki                                                       ##
##  Improved by:   ZZJHONS                                                     ##
	...
	<form action="GameEngine/Game/WorldWonderName.php" method="POST">
		...
		<?php
            ...
            if($village->resarray['f99'] < 15){
                echo 'You need to have World Wonder level 15 to be able to change its name.<center><br />World Wonder name: <input class="text" name="wwname" id="wwname" disabled="disabled" value="'.$wwname.'" maxlength="20"></center><p class="btn"><input type="image" value="BLA" tabindex="9" name="s1" disabled="true" id="btn_ok" class="dynamic_img" src="img/x.gif" alt="OK" /></p>';
            } else if($village->resarray['f99'] >= 15) {
