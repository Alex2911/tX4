...
<body class="presto indexPage">
    <div class="wrapper">
        ...
        <div id="navigation">
            ...
            <table class="menu">
                <tr>
                    ...
                    <td><a href="?signup" class="signup_link mark"><span><?php echo REGISTER; ?></span></a></td>
        ...
        <div id="t4play">
		<a href="notification/">
		<img src="img/t4n/Teaser_Prelandingpage_EN.png" alt="RavianX" />

		</a>
		</div>
        <div id="register_now">
            <a href="?signup" class="signup_link"><?php echo REGISTER; ?></a>
			...
			<div class="grit">
				<div class="infobox">
					<div id="what_is_travian">
                        ...
                        <p class="play_now"><a href="?signup" class="signup_link"><?php echo CLICK_HERE; ?></a></p>
                    </div>
                    <div id="player_counter">
                        <table>
                            <tbody>
                                ...
                                <tr>
                                    <th><?php echo PLAYERS_ACTIVE; ?>:</th>
                                    <td><?php echo $active; ?></td>
                                </tr>
                                <tr>
                                    <th><?php echo PLAYERS_ONLINE; ?>:</th>
		...
		<div id="footer">
			<div class="container">
				...
				<ul class="menu">
                    ...
                    <li class="copyright">&copy; 2012 - RavianX - All rights reserved</li>
				</ul>
			</div>
		</div>
    </div>
