...
{
$xcoord = mysql_query("SELECT x FROM ".TB_PREFIX."wdata WHERE id  = ".$_GET['d']."")or die(mysql_error());
$ycoord = mysql_query("SELECT y FROM ".TB_PREFIX."wdata WHERE id  = ".$_GET['d']."")or die(mysql_error());
$getx = mysql_result($xcoord, 0);
$gety = mysql_result($ycoord, 0);
echo "<a href=\"buyvillage.php?id=".$_GET['d']."&amp;x=".$getx."&amp;y=".$gety."\">&raquo;  Buy this village (250 Gold).</a><br />"; 
