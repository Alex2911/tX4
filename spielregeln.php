...
<div id="header">
	<h1>Welcome to RavianX</h1>
</div>
<div id="navigation">
<a href="http://web.archive.org/web/20101129104431/http://travian.com/index.php" class="home"><img src="http://web.archive.org/web/20101129104431im_/http://travian.com/img/x.gif" alt="RavianX"/></a>
	<table class="menu">
	<tr>
...
<h1>Game Rules</h1>
<p>
The below set of rules are in addition to the General Terms and Conditions of RavianX. You should familiarize yourself with the General Terms and Conditions to verify what is allowed, especially in the case of an account that has been banned for a rule violation.
<br /><br />
